...
<head>
    ...
    <title>Trading Admin| Add FAQ</title>
    <!-- Custom CSS -->
                            ...
                            <form class="form-horizontal" action="function.php" method="POST">
                                <div class="card-body">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="" class="form-control" id="faq_title" name="faq_title" placeholder="FAQ Title">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">FAQ Description</label>
                                        <div class="col-sm-9">
                                            <input type="text" value="" class="form-control" id="faq_desc" name="faq_desc" placeholder="Market Values">
                                        </div>
                                    </div>
