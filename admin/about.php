...
$selectQuery = "SELECT * FROM `about_table` order by id desc";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">About | <a href="add_about.php"  class="btn btn-outline-danger"> Add About <i class="fa fa-plus-square"></i> </a></h4>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $sr; ?></td>
                                                 <td><?php echo $row['about_info']; ?></td>
                                                  <td>
                                                    <a href="about_edit.php?id=<?php echo $row['id']; ?>" title="Edit" class="acti"><i class="mdi mdi-lead-pencil"></i></a>
                                                    <a name="faq_delete" href="about_delete.php?id=<?php echo $row['id']; ?>" title="Delete" class="acti"><i class="mdi mdi-delete"></i></a></td>
                                            </tr>
                                            <?php 
                                                $sr++;
