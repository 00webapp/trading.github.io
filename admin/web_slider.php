                                    ...
                                    <hr>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="file" accept=".jpg,.jpeg,.png" class="form-control" id="image" name="image" placeholder="Market Name">
                                        </div>
                                    </div>
                                     <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="add_slider" id="add_slider" class="btn btn-primary add_market_type">Add </button>
                                        <button type="button" class="btn btn-success update_slider" name="update_slider" id
                                        ="update_slider" disabled>Update</button>
                                    </div>
                                </div>
                                </div>
                            </form>
                                                 ...
                                                 <td><img src="<?php echo $row['image'];?>" width="70px" height="50px"></td>
                                                  <td>
                                                    <!-- <a href="edit_market.php?market_id=<?php echo $row['market_id']; ?>" title="Edit" class="acti"><i class="mdi mdi-lead-pencil"></i></a> -->
                                                     <a href="slider_edit.php?id=<?php echo $row['id']; ?>" class="acti" disabled><i class="mdi mdi-lead-pencil"></i></a><?php echo "&nbsp;" ?>
