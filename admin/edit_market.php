...
<head>
    ...
    <title>Trading Admin| Edit Market</title>
    <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="market_function.php" method="POST">
                                <div class="card-body">
                                    <?php
                                    include("connection.php");
                             $mid = $_GET['market_id'];
                                    ...
                                    <h4 class="card-title">Edit Market</h4>
                                     ...
                                     <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $mdata['market_values']?>" class="form-control" id="market_values" name="market_values" placeholder="Market Values" disabled>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Market Text</label>
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $mdata['market_text']?>" class="form-control" id="market_text" name="market_text" placeholder="Market Text">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                           <select class="form-control" name="mtype" id="mtype">
                                            <option value="3">Select Market</option>
                                               <?php
                                               include("connection.php");
                                                $sql = mysqli_query($connectQuery,"SELECT * FROM `market_type`");

                                                 while($mtype = mysqli_fetch_assoc($sql)) {

                                               ?>
                                               <option value="<?php echo $mtype['market_type_id'];?>"><?php echo $mtype['market_type']?></option>
                                               <?php } ?>
                                           </select>
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Market Type</label>
                                        <div class="col-sm-9">
                                         <button class="btn btn-danger" value="Decline" id="decline" name="decline" onclick="change()" type="button"> Decline</button>
                                          <button class="btn btn-success" value="Approve" id="approved" name="approved" onclick="change_2()" type="button" style="display:none;">  Approve</button>
                                                <input type="hidden" name="mstatus" id="mstatus" value="Decline">
                                        </div>
                                    </div>
                                     <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="update_market" class="btn btn-primary">Update Market</button>
                                    </div>
                                </div>
                            <?php }?>
                                </div>
...
function change(){
    var txt = "Approved";
    document.getElementById("mstatus").value = txt;
