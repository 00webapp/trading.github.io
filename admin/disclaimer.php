...
$selectQuery = "SELECT * FROM `disclaimer_table` order by id desc";
...
<head>
    ...
    <title>Trading - Admin|  - Disclaimer</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Disclaimer | <a href="disclaimer_add.php"  class="btn btn-outline-danger"> Add Disclaimer <i class="fa fa-plus-square"></i> </a></h4>
                        <div class="ml-auto text-right" style="float: right;">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Disclaimer List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                <td><?php echo $sr; ?></td>
                                                 <td><?php echo $row['disclaimer']; ?></td>
                                                  <td>
                                                    <a href="disclaimer_edit.php?id=<?php echo $row['id']; ?>" title="Edit" class="acti"><i class="mdi mdi-lead-pencil"></i></a>
                                                    <a name="faq_delete" href="disclaimer_delete.php?id=<?php echo $row['id']; ?>" title="Delete" class="acti"><i class="mdi mdi-delete"></i></a></td>
                                            </tr>
                                            <?php 
                                                $sr++;
