...
//$selectQuery = "SELECT * FROM `user_market` JOIN users_details ON users_details.user_id = user_market.user_id order by market_id desc";
                                            ...
                                            <tr>
                                                <td><?php echo $row['user_firstname']; ?><?php echo $row['user_lastname']; ?></td>
                                                 <td><?php echo $row['market_nm']; ?></td>
                                                  ...
                                                  <td><?php echo $row['market_text']; ?></td>
