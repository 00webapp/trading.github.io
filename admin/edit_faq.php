...
<head>
    ...
    <title>Trading Admin| Edit FAQ</title>
    <!-- Custom CSS -->
                        ...
                        <div class="card">
                            <form class="form-horizontal" action="function.php" method="POST">
                                <div class="card-body">
                                    ...
                                    include("connection.php");
                             $fid = $_GET['faq_id'];
                                $faq = mysqli_query($connectQuery,"SELECT * FROM `faq_table` where faq_id = '$fid'");

                                    while($fdata = mysqli_fetch_assoc($faq)) {
                                 ?>
                                     <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">FAQ Title</label>
                                        <div class="col-sm-9">
                                            <input type="hidden" value="<?php echo $fdata['faq_id'];?>" class="form-control" id="faq_id" name="faq_id" placeholder="FAQ Title">
                                            <input type="text" value="<?php echo $fdata['faq_label'];?>" class="form-control" id="faq_title" name="faq_title" placeholder="FAQ Title">
                                        </div>
                                    </div>
                                      <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">FAQ Description</label>
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $fdata['faq_desc'];?>" class="form-control" id="faq_desc" name="faq_desc" placeholder="Market Values">
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        <?php
            if (isset($_GET['msg']) && $_GET['msg']) { ?>
                ...
                $('#msgTxt').html("<i class='far fa-grin-alt'></i> Faq Added Successfully");
