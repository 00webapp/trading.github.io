...
$selectQuery = "SELECT * FROM `user_market` JOIN users_details ON users_details.user_id = user_market.user_id join market_type ON market_type.market_type_id = user_market.market_type_id";
