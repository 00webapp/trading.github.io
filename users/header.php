...
<script src="https://crmbux.co.in/Trading/admin/ckeditor/ckeditor.js"></script>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php" style="background: green;">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="https://crmbux.co.in/Trading/admin/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="https://crmbux.co.in/Trading/admin/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="user_profile.php"><i class="ti-user m-r-5 m-l-5"></i> <?php echo $_SESSION['user_name'] ?>&nbsp;&nbsp;<?php echo $_SESSION['lastname'] ?></a>
                                <a class="dropdown-item" href="https://crmbux.co.in/Trading/admin/logout.php"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
