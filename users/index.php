...
$id = $_SESSION['id'];
$selectQuery = "SELECT * FROM `market_table` JOIN user_market ON user_market.market = market_table.mid WHERE market_table.user_id = '$id' order by user_market.market_id desc";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Dashboard | <a href="add_market.php"  class="btn btn-outline-danger"> Add Result <i class="fa fa-plus-square"></i> </a></h4>
