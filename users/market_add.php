        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="market_data.php" method="POST">
                                <div class="card-body">
                                    ...
                                    <hr>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="" class="form-control" id="market_name" name="market_name" placeholder="Market Name">
                                        </div>
                                    </div>
                                     <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" name="add_market_data" class="btn btn-primary">Add Market</button>
                                    </div>
                                </div>
                                </div>
                            </form>
